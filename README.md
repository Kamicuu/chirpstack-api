...
![Tests](https://github.com/kamicuu/chirpstack-api/actions/workflows/main.yml/badge.svg?branch=master)
...
Documentation: https://godoc.org/github.com/kamicuu/chirpstack-api/go

```bash
go get github.com/kamicuu/chirpstack-api/go/v3
```
...
See the README in /java subfolder: https://github.com/kamicuu/chirpstack-api/tree/master/java.
