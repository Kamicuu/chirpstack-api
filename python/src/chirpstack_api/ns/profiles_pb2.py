...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  DESCRIPTOR._serialized_options = b'\n\024io.chirpstack.api.nsB\rProfilesProtoP\001Z$github.com/kamicuu/chirpstack-api/ns'
