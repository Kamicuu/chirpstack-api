...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  DESCRIPTOR._serialized_options = b'\n\025io.chirpstack.api.geoB\026GeolocationServerProtoP\001Z+github.com/kamicuu/chirpstack-api/go/v3/geo'
