...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  DESCRIPTOR._serialized_options = b'\n!io.chirpstack.api.as.external.apiB\rFrameLogProtoP\001Z7github.com/kamicuu/chirpstack-api/go/v3/as/external/api'
